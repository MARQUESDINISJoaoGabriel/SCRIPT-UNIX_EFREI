...
et le scan de précision : qui permet de faire la recherche d'un ou plusieurs port de notre choix , celui-ci demande selon deux option la 3 , et la 4(qui ne fonctionne pas car rediction error ) .
